...
description: >
  ...
  Trigger on "daily brief", "morning brief", "evening brief", "brief me", "catch me up", "what's my day look like", "what happened today", "eod/sod brief", or "brief" alone — also when asked to catch up on the day, communications, or schedule.

  Also trigger on "refresh the [account] update", "regenerate manager update", "refresh section:[slug]", or "/daily-brief Refresh ..." — patches one card/section, not a full brief.

  Also trigger setup on "/daily-brief setup", "set up daily brief", or "configure daily brief" (First-Run Setup).

  Also trigger account-discovery on "find new accounts", "scan for customers", or "find more accounts" (references/first-run-setup.md).
